  ...
  return (
    <>
      {data ? (
        data?.map((unit) => (
          <Link
            to={`/details/${unit.media_type}/${unit.id}`}
            className="rounded-md overflow-clip w-60 sm:w-80 snap-start"
          >
            ...
            <div className="truncate bg-secondary text-highlight flex justify-between">
              ...
              <div className="bg-gray-700 w-1/4 pt-2 pb-3 font-bold text-center text-highlight">
                OPEN
              </div>
            </div>
          </Link>
